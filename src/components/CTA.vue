  ...
  >
    ...
    <div class="relative z-10 max-w-4xl mx-auto text-center">
      ...
      <a
        ...
        class="inline-flex items-center gap-3 bg-white text-black px-8 py-4 rounded-lg border-2 border-white no-underline font-medium transition-all duration-200 hover:bg-black hover:text-white hover:border-black"
      >
